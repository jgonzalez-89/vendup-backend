...
Revision ID: 098c045c69be
Revises: 
Create Date: 2023-03-06 00:24:52.920521
...
def upgrade():
    ...
    sa.Column('price', sa.Numeric(precision=8, scale=2), nullable=True),
    sa.Column('status_paid', sa.Enum('paid', 'pending', 'refunded', name='status_paid_enum_a4'), nullable=True),
